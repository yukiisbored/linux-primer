...
Linux Primer adalah buku pembelajaran Linux yang terbuka dan bebas. Buku ini bersifat gratis dan bebas, dalam kata
lain diperbolehkan untuk dibaca, disalin, didistribusikan, dipelajari, diubah, dan diperbagus. Buku ini berlisensi
dengan Lisensi MIT.
